...
//     ApiService.getAllMedicalFields()
//       .then(response => {
...
//     ApiService.getSubDepartmentsByMedicalFieldId(medicalFieldId)
//       .then(response => {
...
//     ApiService.getSubDepartmentDescription(medicalFieldId, subDepartmentId)
//       .then(response => {
...
//     ApiService.getSubDepartmentFlag(email, subDepartmentId)
//       .then(response => {
...
//     ApiService.getReadPrescription(email, selectedMedicalField.value)
//       .then(response => {
...
//   return (
//     <div>
//       <div className='header'>Medical Fields and Sub-Departments</div>
...
//               </button>
//             </div>
//             <AudioRecordingComponent email={email} medicalField={selectedMedicalField?.label} subDepartment={selectedSubDepartment?.label} sid={sid} mfid={selectedMedicalField.value}/>
//           </div>
//         )}
//       </div>
//     </div>
